...
'<div id=mywindowTITLE>'+ '<table width=100% height=20 border=0 cellpadding=0 cellspacing=0><tr><td valign=middle align=left><font face="' + sFontFamily + '" size=' + sFontSize + ' color="' + sFontColor + '">&nbsp;ù&nbsp;  ' + windowTIT + '</font></td></tr></table>' +'</div>                  '+ '\n'+
